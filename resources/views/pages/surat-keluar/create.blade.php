                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="number" name="klasifikasi" id="klasifikasi" value="{{ old('klasifikasi') }}" placeholder="Masukkan Klasifikasi" class="form-control @error('klasifikasi') is-invalid @enderror" min="1">
                            @error('klasifikasi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
