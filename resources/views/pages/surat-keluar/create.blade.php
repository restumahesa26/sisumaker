                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="number" name="nomor_halaman" id="nomor_halaman" value="{{ old('nomor_halaman') }}" placeholder="Masukkan Nomor Halaman" class="form-control @error('nomor_halaman') is-invalid @enderror">
                            @error('nomor_halaman')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="number" name="klasifikasi" id="klasifikasi" value="{{ old('klasifikasi') }}" placeholder="Masukkan Klasifikasi" class="form-control @error('klasifikasi') is-invalid @enderror" min="1" step="0.1">
                            @error('klasifikasi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
