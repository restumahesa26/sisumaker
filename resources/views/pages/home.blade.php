            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        ...
                        <a class="btn-solid-lg page-scroll" href="#fitur">Pindai Surat</a>
...
<div class="cards-1">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="above-heading" id="fitur">Fitur</div>
                <h2 class="h2-heading">Pindai Surat Untuk Mengetahui Riwayat Surat</h2>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
        <div class="row">
            <div class="col-lg-12">
